...
<body>
        ...
        <div class="carousel" data-carousel>
            ...
            <ul data-slides>
                <li class="slide" data-active>
                    <img src="https://thumbs.dreamstime.com/b/family-health-care-insurance-concept-family-health-care-insurance-concept-stethoscope-paper-cut-family-102883760.jpg" alt="Nature Image #1">
                </li>
                <li class="slide">
    ...
    <a href="page1.html">
        <div class="container">
            ...
            <div class="main">
                ...
                <div class="over">
                    <h1><a href="page2.php">Diseases</a></h1>
                </div>
                <div>
            ...
            <div class="main">
                ...
                <div class="over">
                    <h1><a href="page2.php">Senior <br>Citizens</a></h1>
                </div>
                <div>
            ...
            <div class="main">
                ...
                <div class="over">
                    <h1><a href="page2.php">Physically <br>Disabled<br> People
    </a></h1>
    </div>
    <div>
    ...
    <div class="main">
        ...
        <div class="over">
            <h1><a href="page2.php">Accidents</a></h1>
        </div>
        <div>
